...
Func _Start_1()
	...
	For $i = 0 To 51
		$Result  = _IMGSearch_Area(@scriptdir&"\image\gem1\" & $arr[$i] &".bmp", $position1[0], $position1[1], $position1[2], $position1[3], GUICtrlRead($tolerance2))
		If $Result[0] <> 1 Then
			$Result2 = _IMGSearch_Area(@scriptdir&"\image\gem2\" & $arr[$i] &".bmp", $position1[0], $position1[1], $position1[2], $position1[3], GUICtrlRead($tolerance))
			If $Result2[0] <> 1 Then
